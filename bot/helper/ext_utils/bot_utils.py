...
async def set_commands(client):
    if config_dict['SET_COMMANDS']:
        await client.set_bot_commands([
            BotCommand(f'{BotCommands.MirrorCommand[0]}', 'Upload files to cloud drive'),
            BotCommand(f'{BotCommands.LeechCommand[0]}', 'Upload files to Telegram'),
            BotCommand(f'{BotCommands.QbMirrorCommand[0]}', 'Mirror torrent using qBittorrent to cloud drive'),
            BotCommand(f'{BotCommands.QbLeechCommand[0]}', 'Leech torrent using qBittorrent to Telegram'),
            BotCommand(f'{BotCommands.YtdlCommand[0]}', 'Mirror yt-dlp supported link to cloud drive'),
            BotCommand(f'{BotCommands.YtdlLeechCommand[0]}', 'Leech through yt-dlp supported link to Telegram'),
            ...
            BotCommand(f'{BotCommands.StatsCommand[0]}', 'Check bot stats'),
            ...
            BotCommand(f'{BotCommands.CancelAllCommand[0]}', 'Cancel all tasks added by you'),
